...
class PurchaseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('inventori.pembelian.faktur.index', compact('rows', 'suppliers', 'units'));
    }
    ...
    public function create()
    {
        ...
        return view('inventori.pembelian.faktur.create', compact('suppliers', 'units', 'products', 'productUoms'));
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('inventori.pembelian.faktur.create', compact('purchase', 'suppliers', 'units', 'products', 'items', 'productUoms'));
    }
}
