...
class ErpController extends Controller
{
    ...
    private function masterConfig(string $type): array
    {
        return [
            ...
            'warehouses'=>['title'=>'Gudang','table'=>'warehouses','columns'=>['code','name','address','is_active'],'column_labels'=>['code'=>'Kode','name'=>'Nama Gudang','address'=>'Alamat','is_active'=>'Status'],'fields'=>['code'=>['label'=>'Kode','type'=>'text','required'=>true],'name'=>['label'=>'Nama Gudang','type'=>'text','required'=>true],'address'=>['label'=>'Alamat','type'=>'textarea'],'is_active'=>['label'=>'Status','type'=>'select','options'=>['1'=>'Aktif','0'=>'Nonaktif']]]],
