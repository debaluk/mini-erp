...
<div class="tab-content">
    <div class="tab-pane fade show active" id="setup-unit" role="tabpanel">
        <div class="card shadow-sm mb-3">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('pengaturan.unit-bisnis.store') }}" class="row g-3 align-items-end">
                    @csrf
                    <div class="col-md-2">
                    ...
                    <div class="col-md-1">
                        <div class="form-check mb-2">
                            ...
                            <input class="form-check-input" type="checkbox" name="is_active" value="1" id="unit-active" checked>
