    ...
    <div class="card-body py-3">
        <form id="customerForm" novalidate>
            <div class="row g-2 align-items-end">
                ...
                <div class="col-md-10 d-flex justify-content-end gap-1"><button type="submit" class="btn btn-primary btn-sm" id="customer-submit">Simpan</button><button type="button" class="btn btn-light btn-sm d-none" id="customer-cancel">Batal</button></div>
            </div>
        </form>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded',()=>{
 ...
 const alert=(m,k='success')=>{alertBox.innerHTML='<div class="alert alert-'+k+' py-2 small">'+m+'</div>';setTimeout(()=>alertBox.innerHTML='',3500)};
