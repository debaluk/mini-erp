@extends('layouts.app')
@section('content')
<div class="d-flex justify-content-between align-items-center mb-3"><div><h4 class="mb-1">Penjualan</h4><div class="text-secondary small">Daftar transaksi penjualan</div></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline-success" id="btn-export-sales">Export Excel</button><a href="{{ route('inventori.penjualan.create') }}" class="btn btn-primary">+ Tambah Penjualan</a></div></div>
