        ...
        <div class="modal-content">
            <form id="conversionForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-2">
                        <div class="col-md-6"><div class="form-check"><input class="form-check-input" type="checkbox" name="is_default_purchase" id="is_default_purchase" value="1"><label class="form-check-label" for="is_default_purchase">Default Pembelian</label></div></div>
                        <div class="col-md-6"><div class="form-check"><input class="form-check-input" type="checkbox" name="is_default_sale" id="is_default_sale" value="1"><label class="form-check-label" for="is_default_sale">Default Penjualan</label></div></div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    const table = new DataTable('#conversionDataTable', {
        ...
        columns: [
            ...
            {data:'is_default_sale', render:d => d ? '<span class="badge text-bg-success">Ya</span>' : 'Tidak'},
