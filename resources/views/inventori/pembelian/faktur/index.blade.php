...
<div class="d-flex justify-content-between align-items-center mb-3">
    <div><h4 class="mb-1">Pembelian</h4><div class="text-secondary small">Daftar transaksi pembelian</div></div>
    <a href="{{ route('inventori.pembelian.create') }}" class="btn btn-primary">+ Tambah Pembelian</a>
</div>

<div class="card shadow-sm">
    <div class="card-body border-bottom">
        <form method="GET" action="{{ route('inventori.pembelian') }}" class="row g-2 align-items-end">
    ...
    <div class="table-responsive">
        <table class="table table-hover align-middle mb-0">
            <thead class="table-light"><tr>
                ...
                <th class="text-end">Subtotal</th><th class="text-end">Diskon</th><th class="text-end">Total</th><th>Status</th><th class="text-end">Aksi</th>
            </tr></thead>
            <tbody>
            @forelse($rows as $r)
                <tr>
                    ...
                    <td class="text-end"><a href="{{ route('inventori.pembelian.edit', $r->id) }}" class="btn btn-sm btn-outline-secondary">Edit</a></td>
                </tr>
            @empty
                <tr><td colspan="11" class="text-center text-secondary py-4">Belum ada transaksi pembelian.</td></tr>
            @endforelse
            </tbody>
        </table>
    </div>
