...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Jadi user tidak perlu menginput histori harga secara manual.
        // BOM tetap TIDAK menyimpan harga; BOM hanya menyimpan bahan + qty.
        if (!Schema::hasTable('purchase_price_histories')) {
            return;
        }

        // CATATAN: trigger ini membuat setiap detail pembelian menjadi histori harga.
        // Reference ID menunjuk ke transaksi pembelian sehingga histori dapat diaudit.
    ...
    {
        // CATATAN: rollback hanya menghapus mekanisme otomatisnya.
